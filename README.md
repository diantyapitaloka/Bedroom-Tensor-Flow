...
- Test the model using different camera hardware or in varied lighting conditions, such as nighttime or harsh sunlight. This "stress test" reveals if your model is too really dependent on the high-quality lighting typical of curated datasets.
