...
- TensorBoard Profiling for Bottlenecks: Use the TensorBoard Profiler tool to analyze the execution time of your input pipelines and model layers. This allow you to catch hardware bottlenecks (like the GPU idling while waiting for the CPU to preprocess data) and optimize your data loading using tf.data.Dataset.prefetch.
